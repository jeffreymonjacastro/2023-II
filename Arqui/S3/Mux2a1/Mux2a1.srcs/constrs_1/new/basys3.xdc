...
set_property PACKAGE_PIN V2 [get_ports a8]
set_property PACKAGE_PIN T3 [get_ports a9]
set_property PACKAGE_PIN T2 [get_ports a10]
set_property PACKAGE_PIN R3 [get_ports a11]
set_property PACKAGE_PIN T1 [get_ports a14]
set_property PACKAGE_PIN R2 [get_ports a15]
set_property PACKAGE_PIN W19 [get_ports s0]
set_property PACKAGE_PIN T17 [get_ports s1]
set_property PACKAGE_PIN T18 [get_ports s2]

set_property PACKAGE_PIN W2 [get_ports a12]
set_property PACKAGE_PIN U1 [get_ports a13]
set_property PACKAGE_PIN U17 [get_ports s3]
