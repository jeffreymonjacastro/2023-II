...
try:
    ...
    url += "key=" + "d63049bc101ac4bcdc6b1a64fc5c093d"  # API KEY 2CAPTCHA
    ...
    url_resp += "key=" + "d63049bc101ac4bcdc6b1a64fc5c093d"  # API KEY
    url_resp += "&action=get"
    ...
    # Utilizo el script (JS) que tienen en su documentacion para insertar la solucion dentro de la pagina web
